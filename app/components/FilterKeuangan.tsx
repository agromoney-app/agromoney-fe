	...
	return (
		<>
			...
			<IconButton sx={{ color: "#ffffff" }} onClick={handleClickOpen}>
				<Badge badgeContent={4} color="error" variant="dot" invisible={props.selectedType == ""}>
					<TuneIcon />
				</Badge>
			</IconButton>
			{/* DIALOG */}
			...
			>
				...
				<Stack direction={"row"} paddingX={3}>
					{props.selectedType !== "" && <Chip size="small" label={"Tipe"} onDelete={clearType} />}
				</Stack>
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DatePicker label="Hingga" />
					...
					<FormControl fullWidth>
						...
						<Select value={props.selectedType} label="Tipe" onChange={handleTypeChange}>
